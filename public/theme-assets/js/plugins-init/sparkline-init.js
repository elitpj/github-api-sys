...
if(jQuery('#sparkline8').length > 0 ){
    $("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
        ...
        height: "50",
        lineColor: "#008051",
        fillColor: "rgba(34, 47, 185, .5)",
        minSpotColor: "#008051",
        maxSpotColor: "#008051",
        highlightLineColor: "#008051",
        highlightSpotColor: "#008051",
...
if(jQuery('#sparkline9').length > 0 ){
    $("#sparkline9").sparkline([27, 31, 35, 28, 45, 52, 24, 4, 50, 11, 54, 49, 72, 59, 75], {
        ...
        height: "50",
        lineColor: "#ffe600",
        fillColor: "rgba(255, 230, 1, .5)",
        minSpotColor: "#ffe600",
        maxSpotColor: "#ffe600",
        highlightLineColor: "rgb(255, 230, 1)",
        highlightSpotColor: "#ffe600"
    });
}
...
if(jQuery('#StackedBarChart').length > 0 ){
    $('#StackedBarChart').sparkline([
        ...
        [4, 1, 2]
            ...
            barWidth: 10,
            barSpacing: 7,
            stackedBarColor: ['#008051', '#21b731', '#ff7a01']
        });
}
...
if(jQuery('#sparkline11').length > 0 ){
    ...
    $("#sparkline11").sparkline([24, 61, 51], {
        ...
        height: "100px",
        resize: !0,
        sliceColors: ["rgba(192, 10, 39, .5)", "rgba(0, 0, 128, .5)", "rgba(69, 11, 90, .5)"]
    });
}
