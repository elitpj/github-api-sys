	...
	var dzMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#008051', 'rgb(255, 122, 1)', '#21b731'],
				//responsive:true,
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#ff2625', '#21b731', '#008051'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(255, 38, 37)', 'rgb(39, 129, 213)', '#008051'],
				resize: true
		...
		var barChart = function(){
			...
			Morris.Bar({
				...
				ykeys: ['a', 'b', 'c'],
				labels: ['A', 'B', 'C'],
				barColors: ['#008051', '#21b731', '#ff9f00'],
				hideHover: 'auto',
				gridLineColor: 'transparent',
				resize: true,
				barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#008051', 'rgb(16, 202, 147)', 'rgb(255, 122, 1)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
		...
		var areaChart2 = function(){
			...
			Morris.Area({
				...
				smooth: false,
				hideHover: 'auto',
				lineColors: ['rgb(39, 129, 213)', 'rgb(0, 0, 128)'],
				resize: true
